...
void AmbUnitTest::testRoutine()
{
   ...
   //constructorTest<amb::Font>(LUXIRB); // 4 //TODO: figure out why we can't use amb::Font::LUXIRB directly
   ...
   Util::Log::info("Attempting to load non-existent file. Expecting an Error message...");
...
void  AmbUnitTest::testXml()
{
   ...
   auto testXml = "<group><name>MISCELLANEOUS</name><item><name>TREE</name><desc>Remove: Tree/Step/Deck/Other</desc><LU>300</LU><UC>e300a</UC></item></group>";
