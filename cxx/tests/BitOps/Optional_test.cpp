...
void Optional_test::testRoutine() {
  ...
  Ostream buf;
  buf << maybeInteger;
  requireEqual(buf.at(0), 0b1000'0000);
  requireEqual(buf.at(1), 0);
  requireEqual(buf.at(2), 0);
  requireEqual(buf.at(3), 0b0000'0001);
  requireEqual(buf.at(4), 0b1000'0000);
  ...
  buf << mbv;
  requireEqual(buf.at(4), 0b1100'0000);
